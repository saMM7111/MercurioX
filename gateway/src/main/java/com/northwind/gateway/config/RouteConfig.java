    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("products-read", r -> r
                        .path("/api/products/**")
                        .and().method("GET")
                        .filters(f -> f.filter(new RoleAuthorizationFilter("ADMIN", "MANAGER", "VIEWER")))
                        .uri(BACKEND_URI))
                ...
                .route("products-write", r -> r
                        ...
                        .filters(f -> f.filter(new RoleAuthorizationFilter("ADMIN", "MANAGER")))
                        .uri(BACKEND_URI))
                ...
                .route("products-delete", r -> r
                        .path("/api/products/**")
                        .and().method("DELETE")
                        .filters(f -> f.filter(new RoleAuthorizationFilter("ADMIN")))
                        .uri(BACKEND_URI))
